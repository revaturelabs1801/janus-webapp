...
export class ManageComponent implements OnInit, OnDestroy {
  ...
  skills: string[] = [];
  statuses: string[] = [];
  selectStatus: string = "Select Status";
  ...
  */
  ...
  deleteTraineeFunction(trainee) {
    ...
    var modalRef = this.modalService.open(DeleteTraineeModalComponent);
  ...
  deleteBatchFunction(batch) {
    var modalRef = this.modalService.open(DeleteBatchModalComponent);
